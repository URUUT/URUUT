class PagesController < ApplicationController
  ...
  def index
    ...
    @projects = Kaminari.paginate_array(projects).page(params[:successful]).per(9)
    @project_success = Kaminari.paginate_array(project_success).page(params[:featured]).per(6)
  end
