...
(function() {
  !(function($) {
    ...
    Modal = function(element, options) {
      ...
      return this.options.remote && this.$element.find(".modal-body").load(this.options.remote);
    };
    Modal.prototype = {
      constructor: Modal,
      toggle: function() {
        ...
        return this.backdrop(function() {
          ...
          if (transition) {
            return that.$element.one($.support.transition.end, function() {
              return that.$element.trigger("shown");
            });
          } else {
            return that.$element.trigger("shown");
          }
      ...
      enforceFocus: function() {
        ...
        that = this;
        return $(document).on("focusin.modal", function(e) {
          if (that.$element[0] !== e.target && !that.$element.has(e.target).length) {
      ...
      escape: function() {
        ...
        that = this;
        if (this.isShown && this.options.keyboard) {
          return this.$element.on("keyup.dismiss.modal", function(e) {
            return e.which === 27 && that.hide();
          });
        } else {
          if (!this.isShown) {
            return this.$element.off("keyup.dismiss.modal");
          }
        }
      },
      hideWithTransition: function() {
        ...
        return this.$element.one($.support.transition.end, function() {
          clearTimeout(timeout);
          return that.hideModal();
        });
      },
      ...
      backdrop: function(callback) {
        ...
        if (this.isShown && this.options.backdrop) {
          ...
          this.$backdrop.addClass("in");
          if (doAnimate) {
            return this.$backdrop.one($.support.transition.end, callback);
          } else {
            return callback();
          }
        } else if (!this.isShown && this.$backdrop) {
          this.$backdrop.removeClass("in");
          if ($.support.transition && this.$element.hasClass("fade")) {
            return this.$backdrop.one($.support.transition.end, $.proxy(this.removeBackdrop, this));
          } else {
    ...
    $.fn.modal.Constructor = Modal;
    return $(function() {
      return $("body").on("click.modal.data-api", "[data-toggle=\"modal\"]", function(e) {
  ...
  $(document).ready(function() {
    $(".switch").click(function() {
      if ($(this).hasClass("On")) {
        ...
        return $("form.registration-edit .newsletter-popover").popover({
          content: "If you unsubscribe, you will no longer receive campaign updates, Uruut news, or other recurring emails. \          You may still receive one-time emails based on your use of the site, such as confirmations for your contributions.",
          placement: "top",
          trigger: "hover"
        });
      } else {
        ...
        return $("form.registration-edit .newsletter-popover").popover("destroy");
      }
    });
    return $(".switch").each(function() {
...
(function() {
  $(function() {
    ...
    return $('.badge-wrapper .profile-badge .img-circle').popover({
      placement: "top",
      trigger: "hover"
    });
  });
