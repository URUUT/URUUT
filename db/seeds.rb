...
admin = User.where(email: 'jhiggins@techbridge.org').first_or_create(email: 'jhiggins@techbridge.org', first_name: 'Super', last_name: 'Admin-TB', password: 'frAnce', password_confirmation: 'frAnce', role: 'admin')
